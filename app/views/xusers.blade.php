										...
										<div class="table-responsive">
											<table class="table">
												...
												@foreach( $users as $user )
													<tr>
													  <td><img src="http://www.gravatar.com/avatar/{{ md5(strtolower(trim($user->login))) }}?s=200" class="img-responsive"></td>
													  <td><a href="xusers/{{$user->id}}">{{ $user->firstname }} {{ $user->lastname }}</a></td>
													  <td>{{ $user->login }}</td>
